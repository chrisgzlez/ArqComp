...
do
    ...
    echo "Ejercicio 1 o0"
    F1=`./p21o0 $N`
    echo $F1 >> "results/compute/version1_o0_$N.txt"
    echo $F1

    echo "Ejercicio 1 o2"
    F2=`./p21o2 $N`
    echo $F2 >> "results/compute/version1_o2_$N.txt"
    echo $F2

    echo "Ejercicio 1 o3"
    F3=`./p21o3 $N`
    echo $F3 >> "results/compute/version1_o3_$N.txt"
    echo $F3

    echo "Ejercicio 2"
    F4=`./p22 $N`
    echo $F4 >> "results/compute/version2_o0_$N.txt"
    echo $F4

    echo "Ejercicio 3"
    F5=`./p23 $N`
    echo $F5 >> "results/compute/version3_o0_$N.txt"
    echo $F5

    echo "Ejercicio 4 o0"
    F6=`./p24o0 $N $C`
    echo $F6 >> "results/compute/version4_o0_$N.txt"
    echo $F6

    echo "Ejercicio 4 o0 Dynamic"
    F6=`./p24o0_dynamic $N $C`
    echo $F6 >> "results/compute/version4_o0_dynamic_$N.txt"
    echo $F6

    echo "Ejercicio 4 o0 Guided"
    F6=`./p24o0_guided $N $C`
    echo $F6 >> "results/compute/version4_o0_guided_$N.txt"
    echo $F6

    echo "Ejercicio 4 o0 Collapse"
    F6=`./p24o0_collapse $N $C`
    echo $F6 >> "results/compute/version4_o0_collapse_$N.txt"
    echo $F6


    echo "Ejercicio 4 o2"
    F7=`./p24o2 $N $C`
    echo $F7 >> "results/compute/version4_o2_$N.txt"
    echo $F7
